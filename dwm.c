...
static void (*handler[LASTEvent]) (XEvent *) = {
	...
	/* [EnterNotify] = enternotify, */ /* commented to prevent window focus on hover */
	[Expose] = expose,
	[FocusIn] = focusin,
	[KeyPress] = keypress,
...
drawbar(Monitor *m)
{
	...
	if (m == selmon) {
		...
		drw_text(drw, m->ww - tw - systraywidth, 0, tw, bh,
			 lrpad / 2 - 2, stext, 0);
	}
	...
	drw_map(drw, m->barwin, 0, 0, m->ww - systraywidth, bh);
}
